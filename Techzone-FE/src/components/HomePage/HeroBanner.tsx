            ...
            <div className="relative w-full overflow-hidden bg-gradient-to-br from-[#FAFBF8] to-[#FCFCF9]">
                ...
                <div className="py-12 px-28 relative">
                    <img
                        ...
                        alt="Techzone - Laptop & Linh kiện PC"
                        width={1000}
                        height={1000}
                        draggable={false}
                        ...
                        <div className="order-2 md:order-1">
                            ...
                            >
                                ...
                                <h2 className="text-4xl lg:text-5xl font-bold tracking-tight text-maintext text-nowrap">
                                    <span className="block text-primary uppercase font-extrabold">Techzone <span className='text-maintext'>Sale</span></span>
                                </h2>

                                <p className="text-lg text-maintext max-w-4xl">
                                    Khám phá laptop, linh kiện PC và phụ kiện công nghệ với ưu đãi lên đến 20% cho đơn hàng đầu tiên!
                                </p>
                                <motion.div
                                    initial={{ opacity: 0, y: 20 }}
                                    animate={{ opacity: 1, y: 0 }}
                                ...
                                >
                                    <div className="flex items-center gap-3">
                                        <div className="flex items-center justify-center border border-secondary/50 w-8 h-8 bg-secondary/10 rounded-full">
                                            <Icon path={mdiStar} size={0.8} className="text-primary" />
                                        </div>
                                    ...
                                    <div className="flex items-center gap-3">
                                        <div className="flex items-center justify-center border border-secondary/50 w-8 h-8 bg-extra/10 rounded-full">
                                            <Icon path={mdiShieldCheck} size={0.7} className="text-primary" />
                                        </div>
                                        <span className="text-maintext font-medium">Cam kết chất lượng & bảo hành chính hãng</span>
                                    </div>
                                </motion.div>
                                <motion.div
                                    initial={{ opacity: 0, y: 20 }}
                                    ...
                                    className="flex items-center gap-4 p-4 pl-0"
                                >
                                    ...
                                    <div>
                                        <div className="flex items-center gap-1">
                                            {[1, 2, 3, 4, 5].map((star) => (
                                                <Icon key={star} path={mdiStar} size={0.8} className="text-yellow-400" />
                                            ))}
                                        </div>
                                        <p className="text-base text-gray-600 mt-1 italic">"Laptop chất lượng, giá tốt, hỗ trợ tận tình!"</p>
                                    </div>
                                </motion.div>
