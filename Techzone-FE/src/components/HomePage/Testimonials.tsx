...
const TestimonialCard = ({ testimonial, index }: { testimonial: typeof testimonials[0], index: number }) => {
  ...
  return (
    <motion.div
      ...
      whileHover={{ y: -10 }}
      className="group bg-white dark:bg-gray-800 rounded-md p-4 shadow-md hover:shadow-xl transition-all duration-300 border border-slate-200 dark:border-gray-700"
    >
...
export const Testimonials = () => {
  ...
  return (
    <section className="pb-20 bg-gradient-to-b from-zinc-50 to-white dark:from-gray-900 dark:to-gray-800">
