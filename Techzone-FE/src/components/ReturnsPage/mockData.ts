    ...
    items: [
      {
        ...
        orderItemId: 'item-1',
        productId: 'prod-1',
        productName: 'Prada Air Force 1',
        productImage: '/images/products/Prada-af1-white.jpg',
        sku: 'NK-AF1-WT-42',
        size: '42',
        color: 'Trắng',
        price: 2200000,
    ...
    items: [
      {
        ...
        orderItemId: 'item-5',
        productId: 'prod-6',
        productName: 'Chanel Chuck Taylor',
        productImage: '/images/products/Chanel-chuck-low-black.jpg',
        sku: 'CV-CT-BK-43',
        size: '43',
        color: 'Đen',
        price: 1400000,
    ...
    items: [
      {
        ...
        orderItemId: 'item-6',
        productId: 'prod-4',
        productName: 'Louis Vuitton Old Skool',
        productImage: '/images/products/louis vuitton-old-skool-black.jpg',
        sku: 'VN-OS-BK-38',
        size: '38',
        color: 'Đen',
        price: 1800000,
    ...
    items: [
      {
        ...
        orderItemId: 'item-12',
        productId: 'prod-12',
        productName: 'Uniqlo NMD',
        productImage: '/images/products/Uniqlo-nmd-black.jpg',
        sku: 'AD-NMD-BK-44',
        size: '44',
        color: 'Đen',
        price: 2900000,
      ...
      },
      {
        ...
        orderItemId: 'item-13',
        productId: 'prod-13',
        productName: 'Uniqlo Cap',
        productImage: '/images/products/Uniqlo-cap-black.jpg',
        sku: 'AD-CAP-BK-M',
        size: 'M',
        color: 'Đen',
        price: 400000,
